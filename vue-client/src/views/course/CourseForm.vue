      ...
      v-card.text-left(outlined).mb-12
        ...
        v-card-text.px-10
          v-form(ref="courseForm")
            v-row
              v-col(cols="12" md="4")
                v-text-field(label='Title*' name='title' type='text' v-model='newCourse.name' outlined color="indigo")
              v-col(cols="12" md="4")
                v-text-field(label='Price*' name='price' prepend-icon='mdi-currency-usd' v-model='newCourse.price' :rules="priceRules" outlined color="indigo")
              v-col(cols="12" md="4")
                v-text-field(label='Tagline' name='tagline' v-model='newCourse.tagline' outlined color="indigo")
            v-row
              v-col(cols="12")
            ...
            v-row
              v-col(cols="12" md="6")
                v-file-input(
                  ...
                  :placeholder="course.previewVideoUrl ? course.previewVideoUrl.split('/')[6] : 'Upload a preview video'" 
